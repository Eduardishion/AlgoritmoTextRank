...
if __name__ == '__main__':
    #rutaArchivo = "C:\Users\Caren\Desktop\utilierias_archivos\Desarrollos\Python\TextRank\TextoFuente1.txt"
    rutaArchivo = "C:/Users/Caren/Desktop/utilierias_archivos/Desarrollos/pruevasTesis/6.-CTR/textos fuente sin formatear/TextoFuente10.txt"
    obj = claseMetodos()
    ...
    vectorizer, feature_matrix = obj.build_feature_matrix(sentenciasDelTexto, feature_type='frequency')
    ...
    archicoResumenTRM.close()
    archicoResumenTRG.close()
