...
if __name__ == '__main__':
    ...
    RutaGeneral = param.valueArgsAsString("-RutaGeneral", "")
    RutaArchivo = param.valueArgsAsString("-RutaArchivo", "")
    ...
    RATextRankM = io.open(RutaGeneral+"RATextRankM.txt", "w", encoding="utf-8")
    RATextRankG = io.open(RutaGeneral+"RATextRankG.txt", "w", encoding="utf-8")
    ...
    print  resumen1
    print type(resumen1)
    RATextRankM.write(resumen1.decode("utf-8"))
    ...
    print resumen2
    RATextRankG.write(resumen2.decode("utf-8"))

    #RATextRankG.write(str(resumen2))
